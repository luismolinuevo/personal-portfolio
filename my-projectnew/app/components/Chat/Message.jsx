      ...
      <div className="flex">
        {type != "user" && (
          <div className="flex items-end">
            <div className="h-6 w-6 flex-shrink-0 mr-1">
              <svg
                id="Layer_1"
                data-name="Layer 1"
        ...
        <div className={`flex w-full ${type == "user" ? "justify-end" : "justify-normal"}`}>
          <p
            className={`p-2 text-[13px] break-words rounded-lg w-[80%] ${
              type == "user" ? "bg-green-200" : "bg-gray-300"
            }`}
          >
            {message}
          </p>
